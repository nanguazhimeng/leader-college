...
public class AuthorizationInterceptor extends HandlerInterceptorAdapter {
    ...
    public static final String CONSTANT_KEY = "leader-college";
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(authIgnoreAnnotation == null){
            ...
            if(appuserManager.executeIsTokenExsist(token)){
                ...
                request.setAttribute(LOGIN_USER_KEY, appuserManager.getUserIdByToken(token));
            }else{
            	throw new RRException("token失效，请重新登录",ApiCode.AC_TOEKN_ERROR);
            }
        }
