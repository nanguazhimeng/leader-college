...
public class StoreGoodsController {
	 ...
	 * 信息
	 */
	@RequestMapping("/info/{storeGoodsId}")
	@RequiresPermissions("storegoods:info")
	public R info(@PathVariable("storeGoodsId") String storeGoodsId){
		StoreGoodsEntity storeGoods = storeGoodsService.queryObject(storeGoodsId);
	...
	public R delete(@RequestBody String[] storeGoodsIds){
		storeGoodsService.deleteBatch(storeGoodsIds);
